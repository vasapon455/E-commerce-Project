...
export default function CheckOut(){
    ...
    return(
        <div className="flex justify-center">
             ...
             <h1 className="h-11 first-letter:xl:text-6xl sm:text-4xl xl:mb-20 md:mb-20 sm:mb-20 font-extrabold text-center">Check Out</h1>
            <div >
                { itemsInCart.length > 0 && itemsInCart.map((item,index) => <CheckoutItem key={index.toString()} product={item}/>) }
            </div>

            <div className="flex flex-col justify-center  items-center">
                    <p className={itemsInCart.length===0?"text-black xl:text-4xl m-20":"invisible"}>You don't have any product in cart.</p>
