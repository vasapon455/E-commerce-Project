...
export default function HeroBanner(){
    ...
    return(
    <div className="flex flex-row gap-20 banner-container max-w-1000 relative mt-40 py-3 justify-center align-middle shadow-md  rounded-lg bg-white border border-gray-300 ">
