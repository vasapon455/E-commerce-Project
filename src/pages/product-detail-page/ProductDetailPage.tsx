            ...
            <div className="pt-10 m-10  w-1024">
                <div className="rounded-lg shadow-md p-4  border border-gray-300 bg-white">
                    ...
                    <div className="flex-col justify-center m-8 ">
                        ...
                        <div className="text-xl m-8 "><span className="font-bold">Description:  </span>{product?.description}</div>
                        <div className="flex flex-row justify-between">
                            <p className="p-2 mx-5 text-xl"><span className="font-bold">Price:  </span>${product?.price}</p>
