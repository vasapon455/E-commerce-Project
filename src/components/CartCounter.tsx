...
export default function CartCounter() {
  ...
  return (
    <div className="flex justify-center text-center  bg-black hover:bg-red-800 rounded-lg h-10 m-auto">
          <div className=" inline-flex justify-center text-center align-middle" >
                ...
                <div className=" text-lg m-auto font-bold px-2 flex-1">0</div>
          </div>
    </div>
  )
}
